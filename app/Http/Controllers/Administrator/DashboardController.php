        ...
        $applicants = Applicant::all();
            ...
            Applicant::where('id', $applicant_id)->update(['status' => "qualified"]);
                ...
                $details = [
                    ...
                    Dear Mr./Ms. ' . ucfirst($fullname) .',\r\n

                    Thank you for your application for the' . ucfirst($jobDescription->job_title) . '. Your time and effort are much appreciated.\r\n
                    ...
                    Kind regards,
                    Benguet State University - Human Resource Management Office',
                    'files' => $files
                ];
