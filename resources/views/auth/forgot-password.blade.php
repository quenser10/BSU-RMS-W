		...
		<div class="container h-100">
			<div class="row justify-content-md-center align-items-center h-100">
				<div class="card-wrapper">
					<div class="cardx fat">
						<div class="card-body">
                            <img src="{{url('images/bsu_logo.png')}}" alt="" style="display: block; margin-left: auto; margin-right: auto; width: 50%;" >
							<h4 class="card-title mt-3" style="display: block; margin-left: auto; margin-right: auto; width: 50%;">Forgot Password</h4>
					...
					<div class="footer">
						Copyright &copy; 2022 &mdash; BSU-HRMO
					</div>
				</div>
			</div>
		</div>
